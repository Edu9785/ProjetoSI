...
CREATE TABLE `carrinhocompras` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_profile_idx` (`id_profile`),
  CONSTRAINT `id_profile` FOREIGN KEY (`id_profile`) REFERENCES `profile` (`id`)
...
INSERT INTO `carrinhocompras` VALUES (1,14,0),(2,12,11),(3,16,0),(5,19,0);
